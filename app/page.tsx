...
// Import your existing portfolio page component
...
export default function HomePage() {
  ...
  // Show the portfolio (works for both authenticated and non-authenticated users)
  // The portfolio will show full features for authenticated users
  return <Portfolio isAuthenticated={isAuthenticated} user={user} />;
}